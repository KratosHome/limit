export default {
  ...
  permissionsAftercare:
    'Увімкніть Limit у Accessibility та доступ до браузера в Automation. Якщо після оновлення сайти не відстежуються, видаліть Limit зі списку Accessibility й додайте Limit із «Програм» заново. Повністю завершіть і запустіть Limit.',
  ...
  updates: {
    ...
    manualDetail:
      'Ця копія Limit оновлюється через інсталятор. Завантажте його й замініть Limit у «Програмах». Історія та налаштування збережуться.',
    automaticDetail:
      'Завантажте оновлення й натисніть «Перезапустити й оновити». Limit встановить його автоматично, зберігши історію та налаштування.',
    installerDetail:
      'Limit завершить роботу, коли відкриється інсталятор. Замініть Limit у «Програмах» і запустіть його звідти. Історія та налаштування збережуться. Якщо сайти не відстежуються, перевірте розділ «Доступи macOS» нижче.',
    restartDetail:
      'Перезапуск автоматично встановить оновлення. Історія та налаштування збережуться.',
    check: 'Перевірити оновлення',
    download: 'Завантажити оновлення',
    toastDownload: 'Завантажити',
    install: 'Перезапустити й оновити',
    open: 'Відкрити інсталятор і вийти',
    failed: 'Не вдалося оновити Limit',
    retry: 'Спробувати ще раз',
    details: 'Докладніше',
    detailsLabel: 'Докладніше про оновлення в налаштуваннях',
