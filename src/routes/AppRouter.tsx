...
import type { AppLimit, AppUsage, DashboardData, PermissionKind, Settings as SettingsType, ViewKey } from '../types';
...
export function AppRouter({ data, theme, view, onEditLimit, onOpenActivity, onOpenLimits, onOpenPermissions, onOpenSettings, onPauseLimit, onSetLimit, onSettingsChange, onThemeChange }: AppRouterProps) {
  ...
  return <Overview data={data} onOpenActivity={onOpenActivity} onOpenLimits={onOpenLimits} onOpenSettings={onOpenSettings} onEditLimit={onEditLimit} />;
}
