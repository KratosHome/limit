...
- **Mac:** автоматична перевірка нової версії та повідомлення у відкритому
  застосунку. Кнопка «Завантажити» завантажує DMG у «Завантаження» і показує
  прогрес у Dock та меню Limit. Після перевірки розміру й SHA-512 з метаданих
  релізу кнопка «Відкрити встановщик і завершити Limit» відкриває DMG і завершує
