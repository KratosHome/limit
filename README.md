...
Поведінка встановленого застосунку відрізняється за ОС:

- **Windows:** автоматична перевірка при запуску та кожні чотири години,
  фонове завантаження і встановлення під час виходу через меню tray.
  Завантажене оновлення також можна встановити пунктом «Перезапустити й
  оновити». Закриття вікна лише ховає застосунок, тому не запускає встановлення.
- **Mac:** автоматична перевірка нової версії та повідомлення у відкритому
  застосунку з кнопкою завантаження. Користувач завантажує DMG, завершує Limit
  і замінює його у Applications вручну. Без Developer ID ця конфігурація
  не викликає нативне автоматичне встановлення.
